...
class IRInstructionSpec : XCTestCase {
  func testInstructionOpCodes() {
    ...
    XCTAssertEqual((builder.buildInBoundsGEP(pval, type: IntType.int8, indices: []) as! IRInstruction).opCode, OpCode.getElementPtr)
    XCTAssertEqual((builder.buildGEP(pval, type: IntType.int8, indices: []) as! IRInstruction).opCode, OpCode.getElementPtr)
